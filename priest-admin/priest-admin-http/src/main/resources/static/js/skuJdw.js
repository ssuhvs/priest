    ...
    var step = {
        ...
        Creat_Table: function () {
            ...
            if (bCheck == true) {
                var RowsCount = 0;
                $("#createTable").html("");
                var table = $("<table id=\"process\" border=\"0\" cellpadding=\"1\" cellspacing=\"0\" style=\"width:100%;padding:5px;\"></table>");
                ...
                var itemColumHead2 = $("<th >商家编码</th><th >商品条形码</th>");
