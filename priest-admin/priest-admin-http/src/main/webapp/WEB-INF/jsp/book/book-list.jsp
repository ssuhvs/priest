    ...
    <script type="text/javascript">
        ...
        function openEditWindow(btn) {
            layer.open({
                ...
                area: ['540px', '550px'],
                content: '/book/edit?id=' + btn.value
            });
        }
        ;
    </script>
    ...
    <fieldset class="layui-elem-field layui-field-title">
        ...
        <div class="layui-field-box">
            <blockquote class="layui-elem-quote">
                <button class="btn btn-sm btn-success" onclick="openEditWindow(this)">添加图书</button>
            </blockquote>
                    ...
                    <c:forEach var="entity" items="${page.result}" varStatus="status">
                        <tr class="active">
                            ...
                            <td class="h6">
                                ...
                                <button type="button"
                                        onclick="commonDeleteConfirm('/book/delete?id=${entity.id}')"
...
<script type="application/javascript">
    ...
    var href = '/book/list?page={{number}}';
</script>
