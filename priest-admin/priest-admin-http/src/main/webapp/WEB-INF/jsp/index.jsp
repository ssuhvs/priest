...
<div id="wrapper">
    <!--左侧导航开始-->
    <jsp:include page="common/h_navbar.jsp"/>
    <!--左侧导航结束-->
    <!--右侧部分开始-->
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe id="J_iframe" class="J_iframe" name="iframe0" width="100%" height="100%" src="/admin/indexContent" frameborder="0" data-id="index_v1.html" seamless></iframe>
        </div>
