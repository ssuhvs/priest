    ...
    <script type="text/javascript">
        ...
        function openEditWindow(btn){
            ...
            layer.open({
                ...
                area : ['390px' , '330px'],
                content: '/admin/menu/edit?id='+btn.value,
                end:function(){
...
<div class="layui-tab-content site-demo site-demo-body">
    ...
    <iframe width="0" height="0" style="display:none;" name="commonPostIframe"></iframe>
        ...
        <div class="layui-field-box">
                ...
                <button type="button" class="layui-btn layui-btn-small" onclick="openEditWindow(this)" id="park-add">添加资源</button>
                    ...
                    <c:forEach var="item" items="${page.result}" varStatus="status">
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" onclick="commonDeleteConfirm('/admin/menu/delete?id=${item.id}')" class="layui-btn layui-btn-danger layui-btn-mini">删除</button>
...
<script type="application/javascript">
    ...
    var href = '/admin/menu/list?currentPage={{number}}';
</script>
